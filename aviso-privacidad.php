...
<html lang="es">
  <head>
    ...
    ========================================================= */
      ...
      .site-header.sticky {
        ...
        box-shadow: 0 8px 30px rgba(23, 23, 26, 0.04);
      }
    ...
    ========================================================= */
      ...
      .mobile-menu {
        ...
        box-shadow: 0 25px 45px rgba(23, 23, 26, 0.08);
      }
    ...
    <header class="site-header" id="header">
      <div class="wrap nav">
        <a
          href="./"
          class="brand"
          aria-label="Ir al inicio de CNE Consultorías"
        >
  ...
  ======================================================== -->
    ...
    <nav class="mobile-menu" id="mobileMenu" aria-label="Navegación móvil">
      <a href="index.html#home">Inicio</a>

      <a href="index.html#unidades"> Unidades de negocio </a>

      <a href="index.html#coss"> Metodología COSS </a>

      <a href="index.html#recursos"> Recursos / Blog </a>
        ...
        <div class="wrap">
          <div class="legal-hero-inner">
            ...
            <div class="legal-meta">
              ...
              <a href="./" class="back-home"> ← Volver a CNE Consultorías </a>
            </div>
          </div>
        </div>
      </section>
          ...
          ================================================ -->
            ...
            ================================================== -->
              ...
              <div class="legal-actions">
                <a href="./" class="legal-back-button">
